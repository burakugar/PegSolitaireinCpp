...
{
    int choice;
    std::cout << std::endl<< "Please choose one of the grids: " << std::endl;
flag2:
    std::cin >> choice;
    if (std::cin.fail())
    {
        std::cout << std::endl<< "Please enter an integer: " << std::endl;
        std::cin.clear();
        std::cin.ignore(100, '\n');
        goto flag2;
    }
    else
    {
        ...
        {
            std::cout << std::endl<< "Please enter a valid integer: " << std::endl;
            goto flag2;
        }
        else
            return choice;
